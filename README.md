...
Client and server jars will be deployed in the _file-storage/build_ folder under the folders _fsclient/_ and respectively _fsserver/_.

---

## Running the Server

To run the file storage server navigate to _file-storage/build/fsserver_ and then run
...
From a separate command line, navigate to _file-storage/build/fsclient_ and then run one of the three possible commands
